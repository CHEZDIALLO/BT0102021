...
else
{
	for($i = 0; $i < count($_SESSION['panier']['id_produit']); $i++)
	{
		...
		echo '<td>' . $_SESSION['panier']['prix'][$i] . ' FCFA</td>';
		echo '<td>' . $_SESSION['panier']['prix'][$i]*$_SESSION['panier']['quantite'][$i] . ' FCFA</td>';
	...
	echo "<tr><th colspan='4'>Total</th><td colspan='2'>" . montantTotal() . " FCFA</td></tr>";
	if(userConnecte())
	{
	...
	{
		echo '<tr><td colspan="6"><div class="col-md-12 alert alert-warning text-center">Veuillez vous <a href="003/inscription.php">inscrire</a> ou vous <a href="003/login.php"> connecter </a>afin de pouvoir payer</div></td></tr>';
	}
